...
pub mod synq_service_client {
    ...
    #[derive(Debug, Clone)]
    pub struct SynqServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl SynqServiceClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> SynqServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            SynqServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn activate_request(
            &mut self,
            request: impl tonic::IntoRequest<super::ActivateEvent>,
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/synq.SynqService/ActivateRequest",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("synq.SynqService", "ActivateRequest"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod synq_service_server {
    ...
    pub trait SynqService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn activate_request(
            &self,
            request: tonic::Request<super::ActivateEvent>,
        ) -> std::result::Result<tonic::Response<super::ActiveEvent>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SynqServiceServer<T>
    where
        T: SynqService,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/synq.SynqService/Scroll" => {
                    ...
                    for ScrollSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SynqService>::scroll(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synq.SynqService/Clipboard" => {
                    ...
                    for ClipboardSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SynqService>::clipboard(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/synq.SynqService/ActivateRequest" => {
                    #[allow(non_camel_case_types)]
                    struct ActivateRequestSvc<T: SynqService>(pub Arc<T>);
                    impl<
                        T: SynqService,
                    > tonic::server::UnaryService<super::ActivateEvent>
                    for ActivateRequestSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SynqService>::activate_request(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ActivateRequestSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for SynqServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "synq.SynqService";
    impl<T> tonic::server::NamedService for SynqServiceServer<T> {
